...
import com.ztesoft.smartoa.controller.FlowBandingListController;
import com.ztesoft.smartoa.controller.FlowClassifyController;
import com.ztesoft.smartoa.controller.FlowConfigController;
import com.ztesoft.smartoa.controller.FlowDefineController;
import com.ztesoft.smartoa.controller.NewFormController;
import com.ztesoft.smartoa.controller.OaHomeController;
import com.ztesoft.smartoa.controller.PmAccountController;
import com.ztesoft.smartoa.controller.PmFormController;
import com.ztesoft.smartoa.controller.PmOrgController;
...
//	    me.setError500View("/common/500.jsp");
	...
	public void configRoute(Routes me) {
		...
		me.add("/flowConfig", FlowConfigController.class);
		me.add("/flowClassify", FlowClassifyController.class);
		me.add("/flowDefine", FlowDefineController.class);
		me.add("/pmAccount", PmAccountController.class);
		me.add("/newForm", NewFormController.class,"/form/newForm");
		me.add("/pmOrg", PmOrgController.class);
		me.add("/pmForm", PmFormController.class);
		me.add("/workFlow", ProcessController.class, "/flow/flowRelease");
		me.add("/flowBandingList", FlowBandingListController.class, "/flow/flowBandingList");
		me.add("/oaHome", OaHomeController.class);
	}
	...
	public static void main(String[] args) {
		JFinal.start("WebContent", 8080, "/smartOA", 5);
	}
}
