...
<html lang="en">
  <head>
    ...
    <title>Smart OA |</title>
	
    <!-- Bootstrap -->
    <link href="${ctx}${ctx}/oaHome/vendors/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
    <!-- Font Awesome -->
            ...
            <br />
		      ...
		      <ul class="nav side-menu""  ng-controller="headerController">
		        <li ng-repeat="menu in menus">
		          <a href="#">
		            <i class="{{menu.icon}}"></i> {{menu.name}}<span class="fa fa-chevron-down">ÂÂ</span>
		          </a>
		          <ul class="nav child_menu" >
		            <li ng-repeat="subMenu in menu.children" ng-click="openMenu(subMenu)"><a href="#">{{subMenu.name}}Â</a></li>
		          </ul>
		        </li>
